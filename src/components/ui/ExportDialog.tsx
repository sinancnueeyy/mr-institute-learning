...
export function ExportDialog({ data, filename }: ExportDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white rounded-md shadow-md w-full max-w-sm overflow-hidden animate-fade-in">
        ...
        <div className="p-4 space-y-3">
          <button 
            ...
            className="w-full flex items-center p-3 border border-border rounded-lg hover:border-brand-primary hover:bg-brand-primary/5 transition-colors text-left"
          >
            <div className="w-10 h-10 rounded-full bg-success/20 text-success flex items-center justify-center mr-3">
          ...
          <button 
            ...
            className="w-full flex items-center p-3 border border-border rounded-lg hover:border-brand-primary hover:bg-brand-primary/5 transition-colors text-left"
          >
            <div className="w-10 h-10 rounded-full bg-brand-secondary/10 text-brand-secondary flex items-center justify-center mr-3">
