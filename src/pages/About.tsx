          ...
          <Container>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="space-y-6">
                <div className="h-10 w-3/4 animate-shimmer rounded-lg bg-border/50" />
                <div className="h-24 w-full animate-shimmer rounded-lg bg-border/30" />
              </div>
              <div className="h-64 w-full animate-pulse rounded-md bg-surface-muted border border-border" />
            </div>
          </Container>
        </Section>
      )}
          ...
          <Container>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <SlideIn direction="left" className="grid grid-cols-2 gap-4">
                <img loading="lazy" src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=400&q=80" alt="Students studying" className="rounded-md shadow-md object-cover aspect-square w-full" />
                <img loading="lazy" src="https://images.unsplash.com/photo-1568667256549-094345857637?w=400&q=80" alt="Library" className="rounded-md shadow-md object-cover aspect-square w-full mt-8" />
              </SlideIn>
            </div>
          </Container>
        </Section>
        ...
        <Section className="bg-surface">
          <Container>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {data.vision && (
                <SlideIn delay={0.1} direction="up" className="bg-white p-8 rounded-md shadow-sm border border-border">
                  <h3 className="text-2xl font-bold mb-4">Our Vision</h3>
                  <div className="prose text-text-secondary leading-relaxed" dangerouslySetInnerHTML={{ __html: data.vision }} />
                </SlideIn>
              )}
              {data.mission && (
                <SlideIn delay={0.2} direction="up" className="bg-white p-8 rounded-md shadow-sm border border-border">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {data.values.map((value, i) => (
                <SlideIn key={i} delay={i * 0.1} direction="up" className="text-center">
                  <div className="w-16 h-16 mx-auto bg-surface rounded-full flex items-center justify-center text-brand-primary mb-6 shadow-sm">
          ...
          <Container>
            ...
            <div className="space-y-16">
              {data.chairmanMessage?.message && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center bg-white p-8 rounded-md shadow-sm border border-border">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <p className="text-brand-primary font-semibold mb-6">Chairman</p>
              ...
              {data.principalMessage?.message && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center bg-white p-8 rounded-md shadow-sm border border-border">
                  <div className="md:col-span-2 order-2 md:order-1">
                    ...
                    <p className="text-brand-primary font-semibold mb-6">Principal</p>
            ...
            <Container>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {data.infrastructure.map((fac, i) => (
                     <div key={i} className="flex flex-col md:flex-row gap-6 bg-surface p-4 rounded-md border border-border">
